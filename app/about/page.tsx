	...
	return (
		<SiteShell>
			<section className='space-y-6'>
				<h1 className='text-3xl font-bold tracking-tight text-zinc-900'>About</h1>
			...
			<section className='mt-10 border-t border-zinc-200 pt-8'>
				<h2 className='text-xl font-semibold text-zinc-900'>Focus Areas</h2>
				<ul className='mt-4 grid gap-3 text-sm leading-6 text-zinc-700 sm:grid-cols-2'>
					{coreCompetencies.map((competency) => (
						<li key={competency} className='rounded-lg border border-zinc-200 bg-white p-3'>
							{competency}
						</li>
					))}
				</ul>
