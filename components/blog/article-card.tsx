...
export function ArticleCard ({
	...
	return (
		<article className='border-b border-zinc-200 dark:border-zinc-800 pb-10'>
			...
			<div className='mt-6 space-y-5 text-lg leading-8 text-zinc-700 dark:text-zinc-200'>
			...
			<Link
				href={href}
				className='mt-7 inline-block text-sm font-medium text-zinc-900 dark:text-zinc-100 underline decoration-zinc-300 dark:decoration-zinc-700 underline-offset-4 transition-colors hover:text-rose-500'
			>
				Read more
			</Link>
		</article>
